...
const experience = [
  ['04/2024 — Atual','Apus Soluções em TI','Produtor Audiovisual'],['09/2021 — 04/2024','Rede Novo Tempo de Comunicação','Editor de vídeo pleno'],['11/2019 — 09/2021','ASSIST RJ','Editor de vídeo — Assistente de Mídias I'],['03/2021 — 04/2021','Ilusion — Henry e Klauss','Freelancer — Edição, VFX e Motion'],['08/2019 — 03/2020','Instituto Vital Brazil','Freelancer — Assistência de edição e logger'],['03/2015 — 11/2019','Universidade Federal Fluminense','Editor de vídeo e produtor de conteúdo web'],['11/2017','Tatuí Filmes — Netflix — Paris Filmes','Freelancer — Promos e trailers'],['06/2014 — 03/2015','Box Brazil','Editor de vídeo e produtor de TV'],['01/2012 — 12/2014','Canal Rural — Grupo RBS','Editor e produtor de chamadas'],['05/2010 — 12/2011','TV Unisinos — Canal Futura','Editor e produtor de chamadas'],['11/2009 — 03/2010','Opinião Livre — NET TV','Editor de vídeo'],['02/2009 — 07/2009','Agência Zoom — UNASP','Assistente de arte e desenvolvedor web']
];
const education = {
  av:[['Pós-Graduação em VFX','Meliès','Mar/2022 — Jul/2023'],['Bacharelado em Cinema e Audiovisual','UFF — Universidade Federal Fluminense','Mar/2017 — Dez/2022'],['Videografismo e Efeitos Visuais','Azimut Escola de Animação — 320h','Jan/2017 — Jun/2017']],
  tech:[['Pós-Graduação em Engenharia de Dados e IA','Anhanguera','2026 — 2027'],['Desenvolvimento Full Stack Python','EBAC','Jan/2025 — Out/2025'],['Python para Análise de Dados','USP','Mar/2025 — Jul/2025']]
};
const programming = [
